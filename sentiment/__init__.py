...
default_config = {'repeated': True, 'emoticon': True, 'question': True, 'negation': True, 'ungkapan': True, 'consecutive': True, 'exclamation':True, 'booster': True, 'punctuation': True}
APP_ROOT = os.path.dirname(os.path.abspath(__file__))
# open(os.path.join(APP_ROOT, "sentiwords_id.txt"))

class SentiStrength:
    def __init__(self, config=default_config):
        self.negasi = [line.replace('\n','') for line in open(os.path.join(APP_ROOT, "negatingword.txt")).read().splitlines()]
        self.tanya = [line.replace('\n','') for line in open(os.path.join(APP_ROOT, "questionword.txt")).read().splitlines()]
        #create sentiment words dictionary
        self.sentiwords_txt = [line.replace('\n','').split(":") for line in open(os.path.join(APP_ROOT, "sentiwords_id.txt")).read().splitlines()]
    ...
    def main(self,sentence):
        ...
        return {"max_positive":self.sentences_max_pos,"max_negative":self.sentences_max_neg,"kelas":sentence_result}
